...
//                    Log.d("ABC 5" , lol);
    ...
    private class LongOperation extends AsyncTask<String, Void, String> {
        ...
        protected void onPostExecute(String result) {
            ...
            if (hours == 3) {
                stepsLast3Hours.setText(stepsLastHours);
            }
            if (hours == 5) {
                stepsLast5Hours.setText(stepsLastHours);
            }
        }
    }
    ...
    public void storeData(String responseData, String type) {
        ...
        rowData.put(Provider.Fitbit_Data.DEVICE_ID, "2dca4920-8a8f-48ad-b1fd-a8c5a4668128");
